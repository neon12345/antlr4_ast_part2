...
class  Swift5Parser : public SwiftSupport {
public:
  enum {
  ...
  explicit Swift5Parser(antlr4::TokenStream *input);

  Swift5Parser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~Swift5Parser() override;
  ...
  public:
    Swift5Parser::IdentifierContext *closure_parameter_name = nullptr;
